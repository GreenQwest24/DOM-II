...
h2.forEach(h => {
    document.querySelector('body').addEventListener("wheel", e => {
        const randomColor = Math.floor(Math.ramdom() * 16777215).toString(16);
...
letsGo.addEventListener("drag", () => {
    letsGoText.style.border ="2px solid balck";
...
function prizeE(event) {
    alert(`Congrats! You wi;; recieve ${prize}% off!`);
